...
//confirm 이용해 확인 받기 10/27일 수요일
//ex
const day = confirm("집에 가고 싶나요?")
console.log(day) // 입력한 정보 출력됨, 여기서는 true가 출력됨

5가지 사실 작성해보기.
1. 성인입니까?
2. 당신이 좋아하는 캐릭터는 훈이입니까?
3. 좋아하는 과일은 복숭아인가요?
4. 당신은 사실 민트초코를 증오하죠?
5. 집에 가고싶나요?

const isAdultt = confirm("당신은 성인입니까?")
const favoriteCrtt = confirm("당신이 좋아하는 캐릭터는 훈이인가요?")
const favoriteFruitt = confirm("당신이 좋아하는 과일은 복숭아인가요?")
const thatt = confirm("당신은 사실 민트초코를 증오합니까?")
const restt = confirm("당신은 지금 집에 가고 싶나요?")